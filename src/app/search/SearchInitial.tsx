...
export function SearchInitial({handleSearch, getRecs}: {handleSearch: (ref: RefObject<HTMLTextAreaElement>) => Promise<void>, getRecs: () => Promise<void>}) {
    ...
    return (
        <div className="flex flex-col justify-evenly items-center w-full max-h-screen">
            ...
            <div className="bg-blue-200 h-[20%] flex justify-center items-center min-w-[400px] w-[50%]">
                <SearchBox handleSearch={handleSearch}/>
            </div>
            {state.recs?
            <div className="flex flex-wrap justify-center py-2 bg-yellow-200 h-full w-1/2 min-w-[400px] mt-20 mb-20 font-mono overflow-y-scroll no-scrollbar rounded-xl">
