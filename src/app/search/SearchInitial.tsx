...
export function SearchInitial({handleSearch}: {handleSearch: (ref: RefObject<HTMLTextAreaElement>) => Promise<void>}) {
    return (
        <div className="flex flex-col justify-evenly items-center w-full bg-red-100">
            ...
            <div className="bg-yellow-200 h-full mt-20 mb-20">recs</div>
        </div>
    );
}